        ...
        <div class="mainnav" ng-class="{'mainnav-small' : !isHover}">
            ...
            <div class="mainnav-modules" ng-class="{'mainnav-hidden': !isOpen}">
                <ul class="mainnav-list">
                    ...
                    <li class="mainnav-entry" tooltip tooltip-text="<?= Admin::t('Torna al sito'); ?>" tooltip-position="right" tooltip-disabled="isHover">
                        <span class="mainnav-link" onclick="window.location='/'" ng-class="{'mainnav-link-active' : searchInputOpen }">
                            <i class="mainnav-icon material-icons">replay</i>
                            <span class="mainnav-label">
                                <?= Admin::t('Torna al sito'); ?>
                            </span>
                        </span>
                    </li>
                </ul>
